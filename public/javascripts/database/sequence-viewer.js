	...
	//        var lineJump = 0;
	        ...
	        this.render = function (div, options) {
	            ...
	            if(div.substring(0,1)== "#"){
	            	el = document.getElementById(div.substring(1));	
	            	var divId=div
	            }
	            if(div.substring(0,1)== "."){
	            	console.log("This is still not supported!")
	            	el = document.getElementsByClassName(div.substring(1))

	            }
	            if (el === null) {
	              throw new Error("Cannot find element with id: " + div.substring(1));
	            }
